...
class ColoredObjectsHelper(AbstractHelper):
    def __init__(self, args):
        super(ColoredObjectsHelper, self).__init__(args)
        self.function_name = "solve_colored_objects"
    
    def evaluate_prediction(self, outputs, answer_trigger="Final answer:"):
        agg_pass = []
        agg_task_accuracy = []
        ...
        for oi, o in enumerate(outputs):
            ...
            if "Final answer:" in o:
                model_output = o.split(answer_trigger)[-1].strip()
            else:
    ...
    def load_data(self):
        data_name = "tasks/reasoning_about_colored_objects/data.json"
